...
def get_args_perm():
  ...
  ## Dataset Parameters
  parser.add_argument('-path2data', nargs='+', type=str, default=['projects/dataset_processed/pats-plus-copied/pats-plus-clean'],
                      help='path to data')
  parser.add_argument('-path2outdata', nargs='+', type=str, default=['projects/dataset_processed/pats-plus-copied/pats-plus-clean/'],
  ...
  parser.add_argument('-heuristic_pose_starts', nargs='+', type=int, default=[0],
                      help='estimate pose starts using acceleration')
  parser.add_argument('-audio_average', nargs='+', type=int, default=[0],
                      help='if true, audio features are averaged to match the frequency of pose, if false audio features are subsampled to do the same')
